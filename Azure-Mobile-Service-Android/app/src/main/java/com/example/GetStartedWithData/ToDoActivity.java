...
//		TODO Uncomment the the following code to create the mobile services client
		...
		// Mobile Service URL and key
           	mClient = new MobileServiceClient(
					"https://kipkoandroid.azure-mobile.net/",
					"ZAdcWdQPtohzyQTUsloxztplkawZib11",
					this).withFilter(new ProgressFilter());
            //authenticate
             ToDoActivity.this.authenticate();
			//Get the Mobile Service Table instance to use
			} catch (MalformedURLException e) {
			ToDoActivity.this.createAndShowDialog(new Exception("There was an error creating the Mobile Service. Verify the URL"), "Error");
		}
    ...
    private void authenticate() {
        ...
        Futures.addCallback(mLogin, new FutureCallback<MobileServiceUser>() {
           ...
           ToDoActivity.this.createAndShowDialog((Exception) exc, "Error");
            ...
            public void onSuccess(MobileServiceUser user) {
             ...
             ToDoActivity.this.createAndShowDialog(String.format(
                        "You are now logged in - %1$2s",
                        user.getUserId()), "Success");

             ToDoActivity.this.createTable();
            }
        });
    }
	    ...
	    new AsyncTask<Void, Void, Void>() {
	        ...
	        protected Void doInBackground(Void... params) {
	            ...
	            try {
	               ...
	               ToDoActivity.this.createAndShowDialog(exception, "Error");
	            }
                Looper.loop();
	            return null;
...
//		End of lines to comment out
	...
	private void createAndShowDialog(Exception exception, String title) {
		ToDoActivity.this.createAndShowDialog(exception.toString(), title);
	}
