...
public class ChipmunkActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            InputStream in_s = res.openRawResource(R.raw.chipmunk);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_chipmunk, menu);
        return true;
    }
